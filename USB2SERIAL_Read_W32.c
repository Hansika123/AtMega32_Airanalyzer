	...
	void main(void)
		...
		//create file
       FILE *fp;
       fp = fopen("Airdata.txt", "a+");
       printf("crtate file");
       fprintf(fp, "..................Air analyzer's Airdata results...................\n\n");
       fprintf(fp, "__DATE_____TIME________________________________AIRDATA______________\n");
       printf("write file file");
        ...
        while(1){
					...
					for (j = 0; j < i-1; j++)
						...
						// wirting file
                         ...
                         //fputs(SerialBuffer[j], fp);
                        //fprintf(fp, SerialBuffer[j] );
                        //fclose(fp);

                        }
                        fputs(SerialBuffer,fp);
                        fputs("\n", fp);
                       // *SerialBuffer="";
                        //fclose(fp);
